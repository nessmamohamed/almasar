      ...
      const quserdata = this.props.result.map(row => 
        
            {
               ...
               const data =[
                   ...
                   row.quser.Cname,
                   row.quser.phone,
                row.results[question[0]] || 'راضي جدا',
                reasons[question[0]] || '',
                row.results[question[1]] || 'راضي جدا',
                reasons[question[1]] || '',
                row.results[question[2]] || 'راضي جدا',
                reasons[question[2]] || '',
                row.results[question[3]] || 'راضي جدا',
                reasons[question[3]] || '',
                row.results[question[4]] || 'راضي جدا',
                reasons[question[4]] || "",
                row.results[question[5]] || 'راضي جدا',
                reasons[question[5]] || '',
                row.results[question[6]] || 'راضي جدا',
                reasons[question[6]] || '',
                row.results[question[7]] || 'راضي جدا',
                reasons[question[7]] || '',
                row.results[question[8]] || 'راضي جدا',
                reasons[question[8]]|| '',
